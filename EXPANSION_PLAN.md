...
| 5 | 2 | Repeated CV everywhere claims are | ✅ Done | #5r (d54400a): ECG5000/matched-genus/panel subset to 25 reps (1500 runs) — ECG5000 vec 4.30pp [4.02,4.57] > clf 2.96 > fil 0.96 (24/25 reps); genus vec 3.89 > fil 0.71 > clf 0.41, means 98.35/90.98 (VR/DTM grid); panel pooled dominated by modality composition (dataset 41.22/fil 43.30pp) |
